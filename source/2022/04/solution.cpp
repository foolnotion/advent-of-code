...
auto advent2022::day04() -> result {
    auto pairs = lz::map(aoc::util::readlines("./source/2022/04/input.txt"), detail::parse).toVector();
    auto part1 = std::transform_reduce(pairs.begin(), pairs.end(), u64{0}, std::plus{}, detail::contains<true>);
    auto part2 = std::transform_reduce(pairs.begin(), pairs.end(), u64{0}, std::plus{}, detail::overlaps<true>);
