...
hidden if the `aoc_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `aoc_DEVELOPER_MODE` to the configure
...
Runs the executable target `aoc_exe`.
